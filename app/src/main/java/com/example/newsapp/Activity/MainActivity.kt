...
//    }
    ...
    fun loadNews(){
        ...
        apiInterface.getData("in","sport","a5a506de67624ea9b09b1ebea7e547b4").enqueue(object : Callback<NewsModel>{
...
//                Log.e(TAG, "onResponse: ========" + data )
                ...
                binding.recycler.adapter = NewsAdapter(data?.articles as ArrayList<ArticlesItem>)
            }
